    ...
    <header
        ...
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div class="flex items-center gap-5">
                <router-link to="/login" class="hidden sm:block text-sm font-bold text-primary hover:underline">Log
                    In</router-link>
                <router-link to="/signup"
                    class="bg-primary text-white px-5 py-2.5 rounded-full font-bold text-sm shadow-md shadow-primary/30 hover:bg-primary-dark transition-all scale-100 hover:scale-105">Sign
                    Up</router-link>
            </div>
        </div>
    </header>
