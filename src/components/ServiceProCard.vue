<template>
  <div
    class="bg-white dark:bg-slate-900 rounded-2xl p-8
  ...
  >
    <div class="flex-1">
      ...
      <div class="flex items-center gap-3 mt-2">
        ...
        <span v-if="location" class="text-[11px] text-slate-400 flex items-center gap-1">
...
export default {
  ...
  methods: {
    viewProfile() {
      this.$router.push(`/service/${this.serviceId}`);
    },
  },
};
</script>